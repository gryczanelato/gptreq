    ...
    <body>
        ...
        <section id="admin-panel" class="admin-panel">
                ...
                <div class="scroll-sidebar">
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link active" href="admin-booked.php" aria-expanded="false">
            ...
            if(isset($_POST['update'])) {
              $updateQuery = "UPDATE booked SET course_name='$_POST[course_name]', course_level='$_POST[course_level]', course_date='$_POST[course_date]', coursant_name='$_POST[coursant_name]' WHERE id='$_POST[id]'";
              mysqli_query($conn, $updateQuery);
            }

            //function with query to create delete button
            if(isset($_POST['delete'])) {
                $deleteQuery = "DELETE FROM booked WHERE id='$_POST[id]'";
                                            ...
                                            <tbody>
                                                <?php
                                                    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                                        echo "<form action='admin-booked.php' method='post'>";
                                                            echo "<tr>";
                                                                ...
                                                                echo "<td><input type='text' name='coursant_name' value ='" . $row['coursant_name'] . "' ></td>";
                                                ...
                                                <?php
                                                    echo "<form action='admin-booked.php' method='post'>";
                                                        echo "<tr>";
                                                            ...
                                                            echo "<td><input type='text' name='coursant_name' id='coursant_name'/></td>";
