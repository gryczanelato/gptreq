    ...
    <body>
        ...
        <section id="admin-panel" class="admin-panel">
                ...
                <div class="scroll-sidebar">
                    <nav class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                                <a class="sidebar-link active" href="admin-courses.php" aria-expanded="false">
            ...
            if(isset($_POST['update'])) {
              $updateQuery = "UPDATE courses SET course_name='$_POST[course_name]', course_level='$_POST[course_level]', course_desc='$_POST[course_desc]', course_date='$_POST[course_date]', course_price='$_POST[course_price]', course_img='$_POST[course_img]' WHERE id='$_POST[id]'";
              mysqli_query($conn, $updateQuery);
            }

            //function with query to create delete button
            if(isset($_POST['delete'])) {
                $deleteQuery = "DELETE FROM courses WHERE id='$_POST[id]'";
            ...
            if(isset($_POST['add'])) {
              ...
              $insertQuery = "INSERT INTO courses (course_name, course_level, course_desc, course_date, course_price, course_img) VALUES ('$course_name', '$course_level', '$course_desc', '$course_date', '$course_price', '$course_img')";
                                        ...
                                        <table class="table user-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-top-0">Poziom</th>
                                            ...
                                            <tbody>
                                                <?php
                                                    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                                        echo "<form action='admin-courses.php' method='post'>";
                                                            echo "<tr>";
                                                                ...
                                                                echo "<td><input type='text' name='course_desc' value ='" . $row['course_desc'] . "' ></td>";
                                                                echo "<td><input type='text' name='course_date' value ='" . $row['course_date'] . "' ></td>";
                                                                echo "<td><input type='text' name='course_price' value ='" . $row['course_price'] . "' ></td>";
                                                                echo "<td><input type='text' name='course_img' value ='" . $row['course_img'] . "' ></td>";
                                        ...
                                        <table class="table user-table">
                                            ...
                                            <tbody>
                                                <?php
                                                    echo "<form action='admin-courses.php' method='post'>";
                                                        echo "<tr>";
                                                            echo "<td><input type='text' name='course_name' id='course_name'/></td>";
                                                            echo "<td><input type='text' name='course_level' id='course_level'/></td>";
                                                            echo "<td><input type='text' name='course_desc' id='course_desc'/></td>";
                                                            echo "<td><input type='text' name='course_date' id='course_date'/></td>";
                                                            echo "<td><input type='text' name='course_price' id='course_price'/></td>";
                                                            echo "<td><input type='text' name='course_img' id='course_img'/></td>";
