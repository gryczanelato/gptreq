    ...
    <body>
        ...
        <section id="admin-panel" class="admin-panel">
                ...
                <div class="scroll-sidebar">
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link active" href="admin-newsletter.php" aria-expanded="false">
            ...
            if(isset($_POST['update'])) {
              $updateQuery = "UPDATE newsletter SET newsletter_name='$_POST[newsletter_name]', newsletter_email='$_POST[user_name]' WHERE id='$_POST[id]'";
              mysqli_query($conn, $updateQuery);
            }

            //function with query to create delete button
            if(isset($_POST['delete'])) {
                $deleteQuery = "DELETE FROM newsletter WHERE id='$_POST[id]'";
            ...
            if(isset($_POST['add'])) {
              ...
              $insertQuery = "INSERT INTO newsletter (newsletter_name, newsletter_email) VALUES ('$newsletter_name', '$newsletter_email')";
                                        ...
                                        <table class="table user-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-top-0">Adres email</th>
                                                    <th class="border-top-0"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                                        echo "<form action='admin-newsletter.php' method='post'>";
                                                            echo "<tr>";
                                                                echo "<td><input name='id' value ='" . $row['id'] . "' ></td>";
                                                                echo "<td><input type='text' name='newsletter_name' value ='" . $row['newsletter_name'] . "' ></td>";
                                                                echo "<td><input type='text' name='newsletter_email' value ='" . $row['newsletter_email'] . "' ></td>";
                                        ...
                                        <table class="table user-table">
                                            ...
                                            <tbody>
                                                <?php
                                                    echo "<form action='admin-newsletter.php' method='post'>";
                                                        echo "<tr>";
                                                            echo "<td><input type='text' name='newsletter_name' id='newsletter_name'/></td>";
                                                            echo "<td><input type='text' name='newsletter_email' id='newsletter_email'/></td>";
